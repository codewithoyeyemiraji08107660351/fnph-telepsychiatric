...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        // X-View-As-Session carries the supervision context. Without it here the
        // browser preflight rejects every supervised request before it is sent.
        config.setAllowedHeaders(List.of("Authorization", "Content-Type", "X-Requested-With", "Accept",
                SupervisionContextFilter.HEADER));
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Password change acts on the signed-in account. It must be
                        // matched before the public /auth rule below.
                        .requestMatchers(JwtAuthFilter.PASSWORD_CHANGE_PATH).authenticated()
                        ...
                        // Non-sensitive public settings: emergency number, fee, timings.
                        ...
                        // Spring forwards a failed request to /error. Without this the
                        // forward is unauthenticated, security answers 401, and a server
                        // fault reaches the browser disguised as a sign-in problem.
